...
Route::middleware('auth')->group(function() {
    ...
    Route::get('/item/comment/{item_id}', [CommentController::class, 'commentView'])->name('comment.create);
    Route::post('/item/comment/{item_id}', [CommentController::class, 'commentCreate']);
});
