    ...
    <div class="sell-item">
        <div class="sell-item__img">
            ...
            <form action="/sell" method="POST">
                @csrf
                <input type="file" name="sell-item__img" id="imageUpload" accept='image/*' style="display:none">
            <"></form>
                <button class="ed-btn" id="ImageUploadButton">
                    <span class="ed-btn-text">画像を選択する</span></button>
            </div>
