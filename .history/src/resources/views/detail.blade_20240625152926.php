                ...
                <form class="likes" method="POST" action="">
                    ...
                    <div class="evaluation">
                        @if( Auth::check() )
                            ...
                            <form class="favorite-item" method="POST" action="/item/like/{item_id}">
                                @csrf
                                <input class="like-icon inactive" type="image" src="/images/unlike.png" alt="いいね" width="32px" height />
                            </form>
                            @else
                            <form action="favorite-item" method="POST" action="/item/unlike/{item_id}">
                                @csrf
                                <input class="like-icon inactive" type="image" src="/images/like.png" alt="いいねを外す" width="32px" />
