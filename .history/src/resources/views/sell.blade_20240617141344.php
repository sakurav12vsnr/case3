...
<div class="main">
    ...
    <div class="sell-item">
        ...
        <div class="sell-item__img">
            <input type="file" form="item" name="img_url" id="fileElem" accept="image/*" style="display:none" />
            <button type="button"class="ed-btn" id="fileSelect">画像を選択する</button>
        </div>
        <form action="/sell" id="item" method="POST" enctype='multipart/form-data'>
        @csrf
