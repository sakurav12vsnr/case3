        ...
        <div class="item-detail">
            <div class="item-detail__content">
                ...
                <div class="add-comment">
                    ...
                    <form class="item-comment" method="POST" action="{{ route('unlike', ['item_id' => $item->id]) }}">
                        <textarea name="comment" id="item-comment" cols="30" rows="10" maxlength="120">{{ old('comment') }}</textarea>
                    </div>
